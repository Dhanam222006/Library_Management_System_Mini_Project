...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="allbooks.php"><i class="fas fa-book-open"></i> All Books</a></li>
        <?php endif; ?>

        <?php if($current_page != 'user_history.php'): ?>
        <li><a href="user_history.php"><i class="fas fa-exchange-alt"></i> All Transactions</a></li>
        <?php endif; ?>

        <?php if($current_page != 'borrow_return.php'): ?>
        <li><a href="borrow_return.php"><i class="fas fa-arrow-circle-down"></i> Borrow Books</a></li>
        <?php endif; ?>

        <?php if($current_page != 'borrow_return.php'): ?>
        <li><a href="borrow_return.php"><i class="fas fa-arrow-circle-up"></i> Return Books</a></li>
        <?php endif; ?>
        <!-- Logout -->
